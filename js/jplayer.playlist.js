    ...
    jPlayerPlaylist.prototype = {
        ...
        _options: {// static object, instanced in constructor
            playlistOptions: {
                ...
                upItemClass: "jp-playlist-item-up",
                downItemClass: "jp-playlist-item-down"
            }
        },
        ...
        _createItemHandlers: function() {
            ...
            // Create live handlers for the up controls
            $(this.cssSelector.playlist).off("click", "a." + this.options.playlistOptions.upItemClass).on("click", "a." + this.options.playlistOptions.upItemClass, function() {
                var index = $(this).parent().parent().index();

                if (index == 0)
                    return false;
                var abajo = $(self.cssSelector.playlist + " li:nth-child(" + (index + 1) + ")").html();
                var arriba = $(self.cssSelector.playlist + " li:nth-child(" + (index) + ")").html();
                $(self.cssSelector.playlist + " li:nth-child(" + (index) + ")").html(abajo);
                $(self.cssSelector.playlist + " li:nth-child(" + (index + 1) + ")").html(arriba);

                abajo = self.playlist[index];

                self.playlist[index] = self.playlist[index - 1];
                self.playlist[index - 1] = abajo;

                var onUp = self.option('onUp');
            ...
            // Create live handlers for the down controls
            $(this.cssSelector.playlist).off("click", "a." + this.options.playlistOptions.downItemClass).on("click", "a." + this.options.playlistOptions.downItemClass, function() {
                var index = $(this).parent().parent().index();
                ...
                if ((index+1) == self.playlist.length)
                    return false;
                var abajo = $(self.cssSelector.playlist + " li:nth-child(" + (index + 1) + ")").html();
                var arriba = $(self.cssSelector.playlist + " li:nth-child(" + (index + 2) + ")").html();
                $(self.cssSelector.playlist + " li:nth-child(" + (index + 2) + ")").html(abajo);
                $(self.cssSelector.playlist + " li:nth-child(" + (index + 1) + ")").html(arriba);
